...
public class MovieServlet extends HttpServlet {
    ...
    private void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("Add".equals(action)) {
            ...
            org.superbiz.moviefun.moviesapi.MovieInfo movie = new org.superbiz.moviefun.moviesapi.MovieInfo(null, title, director, genre, rating, year);
            ...
            List<org.superbiz.moviefun.moviesapi.MovieInfo> range;
